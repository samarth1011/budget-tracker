...
FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS="budget_tracker"
...
sudo cp "/home/ubuntu/$PROJECT_MAIN_DIR_NAME/$PROJECT_MAIN_DIR_NAME/nginx/nginx.conf" "/etc/nginx/sites-available/$FOLDER_NAME_WHERE_SETTINGS_FILE_EXISTS"
